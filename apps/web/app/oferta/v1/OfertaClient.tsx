      ...
      <div style={{
        ...
        <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', gap: 12, marginBottom: 16 }}>
          ...
          <div style={{ textAlign: 'right', flexShrink: 0 }}>
            ...
            <div style={{ fontSize: 24, fontWeight: 800, color: T.pinkDeep, lineHeight: 1 }}>R$ 47</div>
    ...
    return (
      <div style={{ minHeight: '100vh', background: T.bg, padding: '24px', fontFamily: fontUi }}>
        <div style={{ maxWidth: 420, margin: '0 auto' }}>
          ...
          <p style={{ color: T.inkSoft, fontSize: 14, marginBottom: 24 }}>R$47 — pagamento único</p>
          ...
          <div style={{ marginTop: 20 }}>
            ...
            >
              🔒 {payType === 'card' ? 'PAGAR R$47' : 'GERAR PIX — R$47'}
            </GreenButton>
          </div>
