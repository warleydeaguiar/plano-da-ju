...
type CheckoutErrorInput = {
  ...
  context?: Record<string, unknown>; // dados extras (installments, etc.)
};

/**
 * Loga um erro de checkout na tabela checkout_events (event_type='checkout_error').
 * Fire-and-forget — NUNCA lança, pra não mascarar o erro original do checkout.
 */
